...
- `fog.updated` → MapSync (not yet implemented)
...
- API key stored as Foundry world setting (GM-only visible)
...
- **Fog of war**: Placeholder only (`map-sync.mjs:223`), not yet implemented
