...
- [x] Frontend tag picker widget (JS) -- search, create, assign on entity profiles
- [x] Tags displayed on entity profile pages (colored chips)
- [x] Tags displayed on entity list cards (batch fetch via GetEntityTagsBatch)
- [ ] Tests written
