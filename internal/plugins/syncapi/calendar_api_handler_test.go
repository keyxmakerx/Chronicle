...
func (s *stubCalendarSvc) ListVisibleCalendars(context.Context, string, int, string) ([]calendar.Calendar, error) {
	return nil, nil
}
func (s *stubCalendarSvc) GetActiveVisibleCalendar(context.Context, string, int, string) (*calendar.Calendar, error) {
	return nil, nil
}
