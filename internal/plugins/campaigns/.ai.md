...
This was the last cross-plugin coupling that pinned `campaigns` to a Foundry-specific surface. With it gone, `internal/plugins/campaigns/` contains zero Foundry references — closes the NW-2.2 plugin-isolation arc end-to-end.
