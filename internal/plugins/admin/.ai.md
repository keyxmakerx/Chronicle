...
- [x] System registry (`internal/systems/registry.go`) with D&D 5e, Pathfinder 2e, Draw Steel
...
- [x] Unified Database page: Migrations · Health (live `RunStartupHealthChecks`) · Backups (Auto/Manual artifacts + restorable snapshots, reusing the backup/restore plugins) · Schema
- [ ] Tests written
