...
| handler.go | 12 thin handlers: Index, NewForm, Create, Show, EditForm, Update, Delete, SearchAPI, GetEntry, UpdateEntryAPI, GetFieldsAPI, UpdateFieldsAPI |
...
- [x] Unit tests (30 tests in service_test.go)
- [ ] Additional test coverage for newer features (fields API, entity types)
