...
| handler.go | 8 thin handlers: Index, NewForm, Create, Show, EditForm, Update, Delete, SearchAPI |
...
- Rich text editor (TipTap) integration is the next priority after this plugin.
