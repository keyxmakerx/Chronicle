...
| service.go | EntityService (CRUD, slug gen, search, type management, SeedDefaults, ReorderEntity with dual-parent model, BulkUpdateType for sync API) |
| handler.go | Thin handlers: CRUD, Search, Entry/Fields/Image APIs, Sidebar Nodes CRUD, Favorites CRUD, Bulk Move, Entity Type management |
