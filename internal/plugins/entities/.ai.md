...
| repository.go | EntityTypeRepository + EntityRepository interfaces + MariaDB impls, SeedDefaults, FULLTEXT search, privacy-aware listing, tag filtering, parent_node_id |
| service.go | EntityService (CRUD, slug gen, search, type management, SeedDefaults, ReorderEntity with dual-parent model) |
