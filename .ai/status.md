...
- **Recent cross-cutting decisions** (most recent first):
  - 2026-06-19 — **Player Character Claiming Stages 1–3 COMPLETE (PR #480/#481/#482)**: audit visibility + database layer + UI (claim banner, owner roster, per-type toggle). Stage 4 (Foundry auto-claim) pending. See `.ai/decisions.md` (ADR-039), `docs/player-character-claiming.md` (operator guide), `entities/.ai.md` §"Player Character Claiming".
